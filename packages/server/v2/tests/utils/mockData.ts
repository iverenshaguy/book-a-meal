...
export const twoDaysTime = moment().add(2, 'days').format('YYYY-MM-DD');

export const businessDto = {
  "role": "caterer",
  "businessName": "Muncherss",
  "email": "muncherss@food.com",
  "phoneNo": "08166557788",
  "address": "4, New Road, Yaba, Lagos"
};

export const createBusinessDto = {
  ...businessDto,
  "password": "muncherssfood",
  "passwordConfirm": "muncherssfood",
};
...
export const userDto = {
  ...
  "firstname": "Dami",
  "lastname": "Adelaide",
  "email": "dami@adelaide.com",
};

export const createUserDto = {
  ...userDto,
  "password": "damiadelaide",
  "passwordConfirm": "damiadelaide"
};
