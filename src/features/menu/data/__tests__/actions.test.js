...
import { mealsObj, customersMenuObj, metadata } from 'src/config/tests/fixtures';
import {
  addMenu,
  editMenu,
  fetchMenu,
...
describe('Menu Actions', () => {
  ...
  describe('Menu Operations', () => {
    ...
    describe('Menu', () => {
      it('should dispatch SET_FETCHING, RECEIVE_MENU_SUCCESS and UNSET_FETCHING on successful fetching of caterer caterer', () => {
      ...
      it('should dispatch SET_FETCHING, RECEIVE_MENU_SUCCESS and UNSET_FETCHING on successful fetching of customer caterer with search', () => {
        const expectedActions = ['SET_MENU_FETCHING', 'RECEIVE_MENU_SUCCESS', 'UNSET_MENU_FETCHING'];
      ...
      it('should dispatch RECEIVE_MORE_MENU_SUCCESS and UNSET_FETCHING on successful fetching of customer caterer with metadata', () => {
        ...
        return store
          .dispatch(fetchMenu('2018-06-07', { ...metadata, next: '/menu?date=2018-06-07&limit=5' }))
          .then(() => {
            const dispatchedActions = store.getActions();
