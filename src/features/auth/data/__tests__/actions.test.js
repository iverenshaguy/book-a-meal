...
import { newCustomer } from 'src/config/tests/fixtures';
import {
  authenticating,
  ...
  mailSendSuccess,
  mailSendFailure,
} from 'src/features/auth/data/actions';
...
const token =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNTE1NDQ0NzkwLCJleHAiOjE1MTU1MzExOTB9.6d1VznIz8slZFioUzvC4KNGDlz_YsUNy95g2LPaEnJE';
  ...
  describe('Auth Operations', () => {
    ...
    describe('Authentication', () => {
      it('should dispatch AUTHENTICATING and SIGNIN_SUCCESS on successful signin', () => {
        ...
        mockReq.onPost(/\/auth\/signin$/).reply(200, { newCustomer, token });
      ...
      it('should dispatch AUTHENTICATING and SIGNIN_ERROR on unsuccessful signin', () => {
        ...
        mockReq.onPost(/\/auth\/signin$/).reply(401, {
      ...
      it('should dispatch AUTHENTICATING and SIGNUP_SUCCESS on successful signup', () => {
        ...
        mockReq.onPost(/\/auth\/signup$/).reply(201, { newCustomer, token });
      ...
      it('should dispatch AUTHENTICATING and SIGNUP_ERROR on unsuccessful signup', () => {
        ...
        mockReq.onPost(/\/auth\/signup$/).reply(422, {
          errors: {
    ...
    describe('Token Refresh', () => {
      ...
      it('should dispatch AUTHENTICATING and AUTHENTICATION_ERROR on unsuccessful authentication', () => {
        ...
        moxios.wait(() =>
          store.dispatch(authenticateUser()).catch(() => {
            const dispatchedActions = store.getActions();
    ...
    describe('Password Reset', () => {
      it('should dispatch SET_AUTH_WORKING, MAIL_SEND_SUCCESS, and UNSET_AUTH_WORKING on forgot password success', () => {
        ...
        mockReq
          .onPost(`${url}/auth/forgot_password`)
          .reply(200, { message: 'A reset token has been sent to your email address' });
      ...
      it('should dispatch SET_AUTH_WORKING, PASSWORD_SET_SUCCESS, and UNSET_AUTH_WORKING on reset password success', () => {
        ...
        mockReq
          .onPost(`${url}/auth/reset_password?token=${token}&email=${newCustomer.email}`)
          .reply(200, { message: 'A reset token has been sent to your email address' });
