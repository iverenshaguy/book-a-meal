 ...
 * @returns {React.ComponentClass} Password Component
 */
export class Password extends Component {
          ...
          {type === 'forgotPassword' && (
            <Fragment>
              ...
              <p className="form-extra-info text-center">
                Signup as a{catererSignupLink} or a{customerSignupLink}
              </p>
            </Fragment>
          )}
        </Fragment>
  ...
  renderResetPasswordComp = () => {
    const { passwordSetSuccess, location, submitError, type } = this.props;
