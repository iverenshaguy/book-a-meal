 ...
 * @exports
 * @function SideNav
 * @returns {React.ComponentClass} SideNav
 */
export class SideNav extends Component {
  ...
  /**
   * @memberof SideNav
   * @returns {React.ComponentClass} NavLinks
   */
  renderNavLinks = () => {
    ...
    return (
      <div className="sidenav-body">
        ...
        <LinkBtn
          clickHandler={() => this.handleLinkClick('/meals')}
          className={`menu-item ${active === 'meals' && 'active'}`}
        >
          Meals
        </LinkBtn>
        <LinkBtn
          clickHandler={() => this.handleLinkClick('/menu')}
          className={`menu-item ${active === 'menu' && 'active'}`}
        >
          Menu
        </LinkBtn>
        <LinkBtn
          clickHandler={() => this.handleLinkClick('/orders')}
  ...
  /**
   * @memberof SideNav
   * @returns {React.ComponentClass} SideNav Component
   */
  render() {
