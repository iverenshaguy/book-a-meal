...
import { renderFormFieldPropTypes } from 'src/features/common/utils/proptypes';

/**
 * @exports
 * @class RenderInput
 * @param {object} props
 * @returns {React.ComponentClass} RenderInput
 */
    ...
    return (
      <Fragment>
        <div className={formInputClass}>
          ...
          />
          &nbsp;
          {this.props.type === 'checkbox' && <label htmlFor={this.props.id}>{this.props.label}</label>}
