...
import fileEventAdapter from 'src/features/common/utils/fileEventAdapter';
import uploadValidation from 'src/features/common/utils/validations/uploadValidation';

import { connect } from 'react-redux';
import {
  actions as uploadImageAction,
  clearUploadError as clearUploadErrorAction,
 ...
 * @extends Component
 * @return {React.ComponentClass} RenderFileInput
 */
export class RenderFileInput extends Component {
   ...
   */
  render() {
    const { id, name, label, uploading, uploadError, updating, formerImgUrl } = this.props;
...
export default connect(mapStateToProps, { uploadImage: uploadImageAction, clearUploadError: clearUploadErrorAction })(
  RenderFileInput
);
