...
describe('Dropdown', () => {
  it('should render the Dropdown component correctly when the type prop is notification', () => {
    const shallowWrapper = shallow(<Dropdown type="notification" toggler={<p>Click Me</p>} content={<div>Hey</div>} />);
  ...
  it('should toggle the showContent state to true when toggle is hovered on', () => {
    const wrapper = mount(<Dropdown type="notification" toggler={<p>Hover over Me</p>} content={<div>Hey</div>} />);
