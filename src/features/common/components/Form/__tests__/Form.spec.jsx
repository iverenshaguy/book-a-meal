...
import { mainFormSetup as setup } from 'src/features/common/components/Form/utils/tests/formSetup';
...
describe('Form', () => {
  ...
  it('should disable the form submit button when submitting the form', () => {
    ...
    const shallowRoot = shallow(<Form {...newProps} dispatch={dispatchMock} />);
  ...
  it('should change the form state when the type prop changes', () => {
    ...
    const shallowRoot = shallow(<Form {...props} dispatch={dispatchMock} />);
  ...
  describe('test for right input', () => {
    it('should handle input change on input change for email field', () => {
      ...
      const wrapper = mountRoot.find(Form);
