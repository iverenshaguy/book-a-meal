...
import { formFields } from 'src/features/common/utils/formHelpers';
...
export const formPropTypes = (type) => ({
  ...
  state: PropTypes.shape({
    values: PropTypes.shape(
      arrayToObject(formFields[type], PropTypes.oneOfType([PropTypes.string, PropTypes.bool, PropTypes.number]))
    ),
