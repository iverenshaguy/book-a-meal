...
import { addOrder, editOrder } from 'src/features/orders/data/actions';
 ...
 * @returns {React.ComponentClass} OrderConfirmation Component
 */
export class OrderConfirmation extends Component {
   ...
   * @returns {React.ComponentClass} Order Summary Component
   */
   ...
   */
  render() {
    const msg = 'Please note that order CANNOT be modified or canceled after 1 minute of order placement.';
    ...
    return (
      <View type="orderConfirm">
        <div className="order-confirmation" style={{ marginTop: '120px' }}>
          <div>
            <p className="text-center" style={{ marginTop: '30px', marginBottom: '0' }}>
              {msg}
            </p>
            <br />
            ...
            <br />
            <Link to="/">
              <button type="button" className="btn btn-sec btn-block">
                Keep Shopping
              </button>
            </Link>
            <br />
            <br />
            <button type="button" className="btn btn-pri btn-block" id="checkout" onClick={this.handleSubmit}>
              Confirm Order
            </button>
          </div>
        </div>
