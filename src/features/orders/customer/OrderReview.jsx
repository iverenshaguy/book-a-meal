...
import { syncValidate, validateRequiredFields } from 'src/features/common/utils/validations';
import formErrorCounter from 'src/features/common/utils/formErrorCount';
...
import RenderInput from 'src/features/common/components/FormComponents/RenderInput';
 ...
 * @returns {React.ComponentClass} OrderReview Component
 */
class OrderReview extends Component {
   ...
   */
  toggleOrderSummary = () => this.setState((prevState) => ({ showOrderSummary: !prevState.showOrderSummary }));
  ...
  /**
   * @memberof OrderReview
   * @returns {React.ComponentClass} Delivery Details Component
   */
  renderInputFields = () => {
    const { values, errors } = this.state;
    ...
    <div>
      ...
      <div className="delivery-details">
        <p className="text-center" style={{ marginBottom: '30px' }}>
          Please fill in or confirm your details below.
        </p>
      ...
      <div className="control-btns">
        ...
        <button className="btn btn-sec" type="submit" onClick={this.handleOrderDetailsSubmit}>
          Continue
        </button>
      </div>
    </div>
  ...
  render() {
    ...
    return (
      <View type="orderReview">
        <div className="order-confirmation">{this.renderDeliveryDetails()}</div>
      </View>
    );
  }
}
