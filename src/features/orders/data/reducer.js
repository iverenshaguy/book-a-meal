...
import getUpdatedItems from 'src/features/common/utils/getUpdatedItems';
  ...
  switch (action.type) {
    ...
    case DELIVER_ORDER_SUCCESS:
      return {
        ...
        totalCashEarned: state.totalCashEarned + calculateCashEarnedFromOrder(action.payload.meals),
      };
    case SET_DELIVERING:
