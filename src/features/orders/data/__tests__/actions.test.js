...
describe('Orders Actions', () => {
  ...
  describe('Orders Operations', () => {
    ...
    describe('Orders', () => {
      it('should dispatch SET_FETCHING, RECEIVE_ORDERS_SUCCESS and UNSET_FETCHING on successful fetching of caterer caterer', () => {
      ...
      it('should dispatch RECEIVE_MORE_ORDERS_SUCCESS and UNSET_FETCHING when metadata is given', () => {
        ...
        return store
          .dispatch(fetchOrders('2018-05-27', { ...metadata, next: `${url}/orders?date=2018-05-27&limit=5` }))
          .then(() => {
            const dispatchedActions = store.getActions();
