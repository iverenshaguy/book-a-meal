...
import errorHandler from 'src/features/common/utils/errorHandler';
import { setFetching, unsetFetching } from 'src/features/common/data/actions';
import reloadOrderPage from 'src/features/common/utils/reloadOrderPage';
import {
  ...
  RECEIVE_ORDERS_FAILURE,
  RECEIVE_ORDERS_SUCCESS,
  RECEIVE_MORE_ORDERS_SUCCESS,
} from 'src/features/orders/constants/actionTypes';

/**
 * @function fetchOrdersSuccess
 * @param {string} type actionType
 * @param {object} ordersObj (caterer, metadata, pendingOrders, totalCashEarned)
