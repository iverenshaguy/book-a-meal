...
describe('Orders', () => {
  ...
  describe('Caterer Orders', () => {
    ...
    it('should render Caterer Orders component correctly', () => {
      const shallowWrapper = shallow(
        <Orders user={caterer} fetchOrders={jest.fn()} orders={caterersOrdersObj.orders} metadata={metadata} />
      );
    ...
    it('should start fetching more order items when Orders Component triggers the loadMoreOrders function', () => {
      ...
      const shallowWrapper = shallow(
        <Orders user={caterer} fetchOrders={fetchOrdersMock} orders={caterersOrdersObj.orders} metadata={{}} />
      );
    ...
    it('should render a message when there are no caterer to show', () => {
      const shallowWrapper = shallow(<Orders user={caterer} fetchOrders={jest.fn()} orders={[]} metadata={metadata} />);
  ...
  describe('Customer Orders', () => {
    it('should render Customer Orders component correctly', () => {
      const shallowWrapper = shallow(
        <Orders user={customer} fetchOrders={jest.fn()} orders={customersOrdersObj.orders} metadata={metadata} />
      );
    ...
    it('should start fetching more order items when Orders Component triggers the loadMoreOrders function', () => {
      ...
      const shallowWrapper = shallow(
        <Orders user={customer} fetchOrders={fetchOrdersMock} orders={customersOrdersObj.orders} metadata={{}} />
      );
    ...
    it('should render a message when there are no caterer to show', () => {
      const shallowWrapper = shallow(<Orders user={customer} fetchOrders={jest.fn()} orders={[]} metadata={{}} />);
