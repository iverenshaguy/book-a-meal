...
import { customerOrder } from 'src/config/tests/fixtures';
import { fetchOrder, fetchOrderSuccess, fetchOrderFailure } from 'src/features/order-details/data/actions';
...
describe('Orders Actions', () => {
  ...
  describe('Single Order Operations', () => {
    ...
    describe('Single Order', () => {
      it('should dispatch SET_FETCHING, RECEIVE_ORDER_SUCCESS and UNSET_FETCHING on successful fetching of caterer caterer', () => {
