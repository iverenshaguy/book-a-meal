...
import { mealsObj, newMeal, metadata } from 'src/config/tests/fixtures';
import {
  addMeal,
  editMeal,
  fetchMeals,
  ...
  fetchMealsSuccess,
  fetchMealsFailure,
} from 'src/features/meals/data/actions';
...
describe('Meals Actions', () => {
  ...
  describe('Meals Operations', () => {
    ...
    describe('Meals', () => {
      ...
      it('should dispatch SET_FETCHING, RECEIVE_MEALS_SUCCESS and UNSET_FETCHING on successful fetching of caterer caterer', () => {
      ...
      it('should dispatch SET_FETCHING, RECEIVE_MEALS_SUCCESS and UNSET_FETCHING on successful fetching of caterer caterer when search param is passed', () => {
        const expectedActions = ['SET_FETCHING', 'RECEIVE_MEALS_SUCCESS', 'UNSET_FETCHING'];
