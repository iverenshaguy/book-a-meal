import reducer from 'src/features/meals/data/reducer';
...
describe('Meals Reducers', () => {
  ...
  it('should handle DELETE_MEAL_SUCCESS action', () => {
    ...
    expect(newState).toEqual({
      ...stateWithMeals,
      items: [...stateWithMeals.items.filter((meal) => meal.id !== '81211c24-51c0-46ec-b1e0-18db55880954')],
    });
  });
