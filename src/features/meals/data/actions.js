...
import { setFetching, unsetFetching, toggleModal } from 'src/features/common/data/actions';
...
} from 'src/features/meals/constants/actionTypes';

/**
 * @function fetchMealsSuccess
 * @param {string} type actionType
 * @param {object} mealsObj (caterer, metadata)
