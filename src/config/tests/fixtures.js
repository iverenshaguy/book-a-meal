...
export const customerToken = `fake-customer-token`;

export const catererToken = `fake-caterer-token`;

export const expiredToken = `fake-expired-token`;
      ...
      meals: [
        {
          ...
          imageUrl:
            'https://static.pulse.ng/img/incoming/origs7167742/5270485143-w980-h640/Pounded-yam-and-Egusi-soup.jpg',
      ...
      meals: [
        {
          ...
          imageUrl:
            'http://www.preciouscore.com/wp-content/uploads/2017/11/How-to-cook-jollof-rice-in-the-oven-750x500.jpg',
