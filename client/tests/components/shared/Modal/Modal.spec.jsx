...
describe('Modal', () => {
  ...
  it('renders correctly', () => {
    const shallowWrapper = shallow(<Modal type="addMeal" isOpen toggleModal={jest.fn()} />);
  ...
  it('does not correctly when modal is closed', () => {
    const shallowWrapper = shallow(<Modal type="addMeal" isOpen={false} toggleModal={jest.fn()} />);
  ...
  it('renders correctly when type is editMeal', () => {
    const shallowWrapper = shallow(<Modal type="editMeal" isOpen toggleModal={jest.fn()} />);
  ...
  it('renders correctly when type is newMealImage', () => {
    const shallowWrapper = shallow(<Modal type="newMealImage" isOpen toggleModal={jest.fn()} />);
  ...
  it('calls toggleModal function prop when close modal icon is clicked', () => {
    ...
    const shallowWrapper = shallow(<Modal type="addMeal" isOpen toggleModal={toggleMock} />);
  ...
  it('renders connected component correctly', () => {
    const comp = (<Provider store={store}><ConnectedModal type="addMeal" isOpen toggleModal={jest.fn()} /></Provider>);
