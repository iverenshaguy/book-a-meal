...
class Password extends Component {
  ...
  getMeta = () => {
    ...
    const catererSignupLink =
      <Link to="/signup?role=caterer">Caterer</Link>;

    const customerSignupLink =
      <Link to="/signup?role=customer">Customer</Link>;
      ...
      extra: (
        <Fragment>
          ...
          <Fragment>
            ...
            <p className="form-extra-info text-center">Signup as a {catererSignupLink} or a {customerSignupLink}</p>
          </Fragment>
          }
        </Fragment>)
    };
  ...
  renderResetPasswordSuccess = () => (
    <div className="password-div">
      ...
      <Link to="/signin">
        <button className="btn btn-pri">Sign In</button>
      </Link>
    </div>)
  ...
  renderInvalidTokenError = () => (
    <div className="password-div">
      ...
      <Link to="/forgot-password">
        <button className="btn btn-pri">Resend Email</button>
      </Link>
    </div>)
  ...
  renderForgotPasswordComp = () => {
    const { mailSendSuccess } = this.props;
    ...
    return (
      <Fragment>
        ...
        {!mailSendSuccess && <Form {...this.props} type={this.props.type} meta={meta} />}
  ...
  renderResetPasswordComp = () => {
    const { passwordSetSuccess, location } = this.props;
    const query = queryString.parse(location.search);
    const { token, email } = query;
    const meta = this.getMeta();
    const invalidTokenError = this.props.submitError === 'Password reset token is invalid or has expired';
    ...
    return (
      <Fragment>
        ...
        <Form {...this.props} token={token} email={email} type={this.props.type} meta={meta} />}
